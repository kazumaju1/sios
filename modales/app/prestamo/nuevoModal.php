            ...
            <div class="modal-body">
                <form action="guarda.php" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" name="fk_usuario" id="fk_usuario" class="form-control" rows="3" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="fecha_in" class="form-label">Fecha inicio</label>
                        <input type="date" name="fecha_in" id="fecha_in" class="form-control" rows="3" required>
                    </div>
                    <div class="mb-3">
                        <label for="fecha_fin" class="form-label">Fecha fin</label>
                        <input type="date" name="fecha_fin" id="fecha_fin" class="form-control" rows="3" required>
                    </div>
                    <div class="mb-3">
                        <label for="herramienta" class="form-label">Herramienta</label>
                        <input type="text" name="herramienta" id="herramienta" class="form-control" rows="3" required>
                    </div>
                    <div class="mb-3">
                        <label for="material" class="form-label">Material</label>
                        <input type="text" name="material" id="material" class="form-control" rows="3" required>
                    </div>
                    <!-- <div class="mb-3">
