        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="actualiza.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="fk_presentacion" class="form-label">Presentacion</label>
                        <input type="text" name="fk_presentacion" id="fk_presentacion" class="form-control" rows="3" required>
                    </div>
                    <div class="mb-3">
                        <label for="cantidad" class="form-label">Cantidad</label>
                        <input type="text" name="cantidad" id="cantidad" class="form-control" rows="3" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="precio" id="precio" class="form-control" rows="3" required>
                    </div>
                    <!-- <div class="mb-3">
